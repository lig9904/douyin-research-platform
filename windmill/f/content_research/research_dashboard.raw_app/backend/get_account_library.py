...
def main(
    ...
    # This endpoint is the old global account catalogue.  Project-scoped
    # readers use the roster APIs instead; never query this catalogue until
    # Windmill identity and its server-owned administrator list both pass.
